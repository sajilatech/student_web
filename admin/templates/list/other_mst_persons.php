			...
			<div class="page-head" id="showlinks">
				<ol class="breadcrumb">
                 ...
                 <li><a href="#">Other MST Persons</a></li>
				  <li class="active">Other MST Persons Listing</li>
				</ol>
			</div>	
		<div class="cl-mcont">
				...
				<div class="col-md-12">
					<div class="block-flat">
						...
						<div class="content">
                            ...
                            <form role="form" method="post" action="other_mst_persons.php">  
					...
					<div class="block-flat">
						<div class="header">							
                         ...
                         <div class="pull-left" style="padding-bottom:10px"><div class="dataTables_info" id="datatable_info">
                            <a href="other_mst_persons.php?add=1"><div class="btn-group"><button class="btn btn-sm btn-success" type="button"><i class="fa fa-plus-square"></i></button><button class="btn btn-sm btn-default" type="button">Add New</button></div></a>                            
						...
						<div class="content">
							...
							<div class="table-responsive">
                            <form name="eventform" method="post" action="other_mst_persons.php?doaction=deleterecord">
...
while($row = mysql_fetch_array($result1)) {
 $count_no++;
   $parish_row = getRowByID(MTABLE."parish",'parish_ID',$row['parish_ID'],"");
?>
                                    
										<tr class="gradeA <?php if($count_no%2!=0) { echo 'class="odd"'; } else { echo 'class="even"'; } ?>">
									
                                    <td><input name="list[]" id="list<?php echo $count_no; ?>" class="chkbx" value="<?php echo $row['other_mst_person_ID']; ?>" type="checkbox"></td>
                                            <td><?php echo $count_no; ?></td>
                                            <td><?php echo $row['name']; ?></td>
                                              <td><?php foreach($persons_category_list as $key=>$value){ 
											  if($key==$row['category']){
												   echo $value; 
												}
												} ?></td>
										  ...
										  <td><?php echo $parish_row['name']; ?></td>
											<td><a data-placement="top" data-toggle="tooltip" data-original-title="Edit" class="label label-primary" href="other_mst_persons.php?edit=1&select_id=<?php echo $row['other_mst_person_ID'];?>"><i class="fa fa-pencil"></i></a>
                                            <a data-placement="top" data-toggle="tooltip" data-original-title="Delete" class="label label-danger" href="other_mst_persons.php?doaction=delete&select_id=<?php echo $row['other_mst_person_ID'];?>"><i class="fa fa-times"></i></a></td>
	...
	for(i=0;i<a.length;i++){
		...
		else
		{
			if(vl == 3)
			{
				...
				{
				form_name.action = "other_mst_persons.php?doaction=publish";
				form_name.submit();
				}
				else
				return false;
			...
			else if(vl == 4)
			{
				...
				{
				form_name.action = "other_mst_persons.php?doaction=unpublish";
				form_name.submit();
				}
				else
				return false;
