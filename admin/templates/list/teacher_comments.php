			...
			<div class="page-head" id="showlinks">
				<ol class="breadcrumb">
                 ...
                 <li><a href="teacher_comments.php">Teacher Comments</a></li>
				  <li class="active">Teacher Comments Listing</li>
				</ol>
			</div>	
		<div class="cl-mcont">
				...
				<div class="col-md-12">
					<div class="block-flat">
						...
						<div class="content">
                            ...
                            <form role="form" method="post" action="teacher_comments.php">  
					...
					<div class="block-flat">
						<div class="header">							
                         ...
                         <div class="pull-left" style="padding-bottom:10px"><div class="dataTables_info" id="datatable_info">
                            <a href="teacher_comments.php?add=1"><div class="btn-group"><button class="btn btn-sm btn-success" type="button"><i class="fa fa-plus-square"></i></button><button class="btn btn-sm btn-default" type="button">Add New</button></div></a>                            
						...
						<div class="content">
							...
							<div class="table-responsive">
                            <form name="eventform" method="post" action="teacher_comments.php?doaction=deleterecord">
...
while($row = mysql_fetch_array($result1)) {
 $count_no++;
  $student_row = getRowByID(MTABLE."students",'student_ID',$row['student_ID'],"");
   $teacher_row = getRowByID(MTABLE."teachers",'teacher_ID',$row['teacher_ID'],"");
?>
                                    
										<tr class="gradeA <?php if($count_no%2!=0) { echo 'class="odd"'; } else { echo 'class="even"'; } ?>">
										<td><input name="list[]" id="list<?php echo $count_no; ?>" class="chkbx" value="<?php echo $row['teacher_comment_ID']; ?>" type="checkbox"></td>
                                            <td><?php echo $count_no; ?></td>
                                            <td><?php echo $student_row['name']; ?></td>
                                              <td><?php echo $teacher_row['name']; ?></td>
										
											<td><a data-placement="top" data-toggle="tooltip" data-original-title="Edit" class="label label-primary" href="teacher_comments.php?edit=1&select_id=<?php echo $row['teacher_comment_ID'];?>"><i class="fa fa-pencil"></i></a>
                                            <a data-placement="top" data-toggle="tooltip" data-original-title="Delete" class="label label-danger" href="teacher_comments.php?doaction=delete&select_id=<?php echo $row['teacher_comment_ID'];?>"><i class="fa fa-times"></i></a>
                                             <a  href="teacher_comments_view.php?select_id=<?php echo $row['teacher_comment_ID'];?>"><span class="badge">View</span></a></td>
	...
	for(i=0;i<a.length;i++){
		...
		else
		{
			if(vl == 3)
			{
				...
				{
				form_name.action = "teacher_comments.php?doaction=publish";
				form_name.submit();
				}
				else
				return false;
			...
			else if(vl == 4)
			{
				...
				{
				form_name.action = "teacher_comments.php?doaction=unpublish";
				form_name.submit();
				}
				else
				return false;
