			...
			<div class="page-head" id="showlinks">
				<ol class="breadcrumb">
                 ...
                 <li><a href="#">Parish</a></li>
				  <li class="active">Parish Listing</li>
				</ol>
			</div>	
		<div class="cl-mcont">
						...
						<div class="content">
							...
							<table class="table no-border hover">
								<thead class="no-border">
                                    ...
                                    <tr>
                                   <th style="width:8%;">Diocese</th>
										<th style="width:30%;"><select name="diocese_id" id="diocese_id" class="form-control" required>
					...
					<div class="block-flat">
						<div class="header">							
                         ...
                         <div class="pull-left" style="padding-bottom:10px"><div class="dataTables_info" id="datatable_info">
                            <a href="parish.php?add=1"><div class="btn-group"><button class="btn btn-sm btn-success" type="button"><i class="fa fa-plus-square"></i></button><button class="btn btn-sm btn-default" type="button">Add New</button></div></a>                            
...
while($row = mysql_fetch_array($result1)) {
 $count_no++;
   $diocese_row = getRowByID(MTABLE."diocese",'diocese_ID',$row['diocese_ID'],"");
?>
                                    
										<tr class="gradeA <?php if($count_no%2!=0) { echo 'class="odd"'; } else { echo 'class="even"'; } ?>">
									
                                    <td><input name="list[]" id="list<?php echo $count_no; ?>" class="chkbx" value="<?php echo $row['parish_ID']; ?>" type="checkbox"></td>
                                            <td><?php echo $count_no; ?></td>
                                            <td><?php echo $row['name']; ?></td>
                                             <td><?php echo $row['phone']; ?></td>
										  <td><?php echo $diocese_row['diocese_name']; ?></td>
											<td><a data-placement="top" data-toggle="tooltip" data-original-title="Edit" class="label label-primary" href="parish.php?edit=1&select_id=<?php echo $row['parish_ID'];?>"><i class="fa fa-pencil"></i></a>
                                            <a data-placement="top" data-toggle="tooltip" data-original-title="Delete" class="label label-danger" href="parish.php?doaction=delete&select_id=<?php echo $row['parish_ID'];?>"><i class="fa fa-times"></i></a></td>
