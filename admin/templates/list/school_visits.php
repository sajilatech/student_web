				...
				<div class="col-md-12">
					<div class="block-flat">
						...
						<div class="content">
                            ...
                            <form role="form" method="post" action="school_visits.php">  
					...
					<div class="block-flat">
						<div class="header">							
                         ...
                         <div class="pull-left" style="padding-bottom:10px"><div class="dataTables_info" id="datatable_info">
                            <a href="school_visits.php?add=1"><div class="btn-group"><button class="btn btn-sm btn-success" type="button"><i class="fa fa-plus-square"></i></button><button class="btn btn-sm btn-default" type="button">Add New</button></div></a>                            
...
?>
                                    ...
                                    <td><input name="list[]" id="list<?php echo $count_no; ?>" class="chkbx" value="<?php echo $row['school_visit_ID']; ?>" type="checkbox"></td>
                                            <td><?php echo $count_no; ?></td>
                                            <td><?php echo $row['school_name']; ?></td>
                                            <td><?php echo $row['school_contact_no']; ?></td>
                                             <td><?php echo date('d-M-Y', $row['visit_date']); ?></td>
                                              <td><?php echo $row['visit_who']; ?></td>
											<td><a data-placement="top" data-toggle="tooltip" data-original-title="Edit" class="label label-primary" href="school_visits.php?edit=1&select_id=<?php echo $row['school_visit_ID'];?>"><i class="fa fa-pencil"></i></a>
                                            <a data-placement="top" data-toggle="tooltip" data-original-title="Delete" class="label label-danger" href="school_visits.php?doaction=delete&select_id=<?php echo $row['school_visit_ID'];?>"><i class="fa fa-times"></i></a></td>
	...
	for(i=0;i<a.length;i++){
		...
		else
		{
			if(vl == 3)
			{
				...
				{
				form_name.action = "school_visits.php?doaction=publish";
				form_name.submit();
				}
				else
				return false;
			...
			else if(vl == 4)
			{
				...
				{
				form_name.action = "school_visits.php?doaction=unpublish";
				form_name.submit();
				}
				else
				return false;
