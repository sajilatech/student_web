			...
			<div class="page-head" id="showlinks">
				<ol class="breadcrumb">
                 ...
                 <li><a href="#">Confidential Reports</a></li>
				  <li class="active">Confidential Reports Listing</li>
				</ol>
			</div>	
		<div class="cl-mcont">
				...
				<div class="col-md-12">
					<div class="block-flat">
						...
						<div class="content">
                            ...
                            <form role="form" method="post" action="confidential_reports.php">  
					...
					<div class="block-flat">
						<div class="header">							
                         ...
                         <div class="pull-left" style="padding-bottom:10px"><div class="dataTables_info" id="datatable_info">
                            <a href="confidential_reports.php?add=1"><div class="btn-group"><button class="btn btn-sm btn-success" type="button"><i class="fa fa-plus-square"></i></button><button class="btn btn-sm btn-default" type="button">Add New</button></div></a>                            
						...
						<div class="content">
							...
							<div class="table-responsive">
                            <form name="eventform" method="post" action="confidential_reports.php?doaction=deleterecord">
...
?>
										...
										<td><input name="list[]" id="list<?php echo $count_no; ?>" class="chkbx" value="<?php echo $row['creport_ID']; ?>" type="checkbox"></td>
                                            <td><?php echo $count_no; ?></td>
                                            <td><?php echo $student_row['name']; ?></td>
                                            <td><?php echo $row['title']; ?></td>
										 <td><?php echo $row['interview_comments']; ?></td>
                                          <td><?php echo $row['psychological_results']; ?></td>
											<td><a data-placement="top" data-toggle="tooltip" data-original-title="Edit" class="label label-primary" href="confidential_reports.php?edit=1&select_id=<?php echo $row['creport_ID'];?>"><i class="fa fa-pencil"></i></a>
                                            <a data-placement="top" data-toggle="tooltip" data-original-title="Delete" class="label label-danger" href="confidential_reports.php?doaction=delete&select_id=<?php echo $row['creport_ID'];?>"><i class="fa fa-times"></i></a>
                                              <a  href="confidential_reports_view.php?select_id=<?php echo $row['creport_ID'];?>"><span class="badge">View</span></a>
                                            </td>
	...
	for(i=0;i<a.length;i++){
		...
		else
		{
			if(vl == 3)
			{
				...
				{
				form_name.action = "confidential_reports.php?doaction=publish";
				form_name.submit();
				}
				else
				return false;
			...
			else if(vl == 4)
			{
				...
				{
				form_name.action = "confidential_reports.php?doaction=unpublish";
				form_name.submit();
				}
				else
				return false;
