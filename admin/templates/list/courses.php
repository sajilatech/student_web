<div class="container-fluid" id="pcont">
			<div class="page-head" id="showlinks">
				<ol class="breadcrumb">
                 ...
                 <li><a href="#">Normal Courses</a></li>
				  <li class="active">Courses Listing</li>
				</ol>
			</div>	
		<div class="cl-mcont">
					...
					<div class="block-flat">
						<div class="header">							
                         ...
                         <div class="pull-left" style="padding-bottom:10px"><div class="dataTables_info" id="datatable_info">
                            <a href="courses.php?add=1"><div class="btn-group"><button class="btn btn-sm btn-success" type="button"><i class="fa fa-plus-square"></i></button><button class="btn btn-sm btn-default" type="button">Add New</button></div></a>                            
						...
						<div class="content">
							...
							<div class="table-responsive">
                            <form name="eventform" method="post" action="courses.php?doaction=deleterecord">
...
?>
										...
										<tr class="gradeA <?php if($count_no%2!=0) { echo 'class="odd"'; } else { echo 'class="even"'; } ?>">
											...
											<td><a data-placement="top" data-toggle="tooltip" data-original-title="Edit" class="label label-primary" href="courses.php?edit=1&select_id=<?php echo $row['course_ID'];?>"><i class="fa fa-pencil"></i></a>
                                            <a data-placement="top" data-toggle="tooltip" data-original-title="Delete" class="label label-danger" href="courses.php?doaction=delete&select_id=<?php echo $row['course_ID'];?>"><i class="fa fa-times"></i></a></td>
	...
	for(i=0;i<a.length;i++){
		...
		else
		{
			if(vl == 3)
			{
				...
				{
				form_name.action = "courses.php?doaction=publish";
				form_name.submit();
				}
				else
				return false;
			...
			else if(vl == 4)
			{
				...
				{
				form_name.action = "courses.php?doaction=unpublish";
				form_name.submit();
				}
				else
				return false;
