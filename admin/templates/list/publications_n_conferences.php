			...
			<div class="page-head" id="showlinks">
				<ol class="breadcrumb">
                 ...
                 <li><a href="#">Publications And Conferences</a></li>
				  <li class="active">Publications And Conferences Listing</li>
				</ol>
			</div>	
		<div class="cl-mcont">
				...
				<div class="col-md-12">
					<div class="block-flat">
						...
						<div class="content">
                            ...
                            <form role="form" method="post" action="publications_n_conferences.php">  
					...
					<div class="block-flat">
						<div class="header">							
                         ...
                         <div class="pull-left" style="padding-bottom:10px"><div class="dataTables_info" id="datatable_info">
                            <a href="publications_n_conferences.php?add=1"><div class="btn-group"><button class="btn btn-sm btn-success" type="button"><i class="fa fa-plus-square"></i></button><button class="btn btn-sm btn-default" type="button">Add New</button></div></a>                            
						...
						<div class="content">
							...
							<div class="table-responsive">
                            <form name="eventform" method="post" action="publications_n_conferences.php?doaction=deleterecord">
...
?>
										...
										<td><input name="list[]" id="list<?php echo $count_no; ?>" class="chkbx" value="<?php echo $row['publication_ID']; ?>" type="checkbox"></td>
											...
											<td><a data-placement="top" data-toggle="tooltip" data-original-title="Edit" class="label label-primary" href="publications_n_conferences.php?edit=1&select_id=<?php echo $row['publication_ID'];?>"><i class="fa fa-pencil"></i></a>
                                            <a data-placement="top" data-toggle="tooltip" data-original-title="Delete" class="label label-danger" href="publications_n_conferences.php?doaction=delete&select_id=<?php echo $row['publication_ID'];?>"><i class="fa fa-times"></i></a>
                                      <a  href="publications_n_conferences_view.php?select_id=<?php echo $row['publication_ID'];?>"><span class="badge">View</span></a>       
                                            </td>
	...
	for(i=0;i<a.length;i++){
		...
		else
		{
			if(vl == 3)
			{
				...
				{
				form_name.action = "publications_n_conferences.php?doaction=publish";
				form_name.submit();
				}
				else
				return false;
			...
			else if(vl == 4)
			{
				...
				{
				form_name.action = "publications_n_conferences.php?doaction=unpublish";
				form_name.submit();
				}
				else
				return false;
