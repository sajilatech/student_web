			...
			<div class="page-head" id="showlinks">
				<ol class="breadcrumb">
                 ...
                 <li><a href="#">Special Days</a></li>
				  <li class="active">Special Days Listing</li>
				</ol>
			</div>	
		<div class="cl-mcont">
				...
				<div class="col-md-12">
					<div class="block-flat">
						...
						<div class="content">
                            ...
                            <form role="form" method="post" action="parish.php">  
					...
					<div class="block-flat">
						<div class="header">							
                         ...
                         <div class="pull-left" style="padding-bottom:10px"><div class="dataTables_info" id="datatable_info">
                            <a href="special_days.php?add=1"><div class="btn-group"><button class="btn btn-sm btn-success" type="button"><i class="fa fa-plus-square"></i></button><button class="btn btn-sm btn-default" type="button">Add New</button></div></a>                            
						...
						<div class="content">
							...
							<div class="table-responsive">
                            <form name="eventform" method="post" action="parish.php?doaction=deleterecord">
...
?>
                                    ...
                                    <td><input name="list[]" id="list<?php echo $count_no; ?>" class="chkbx" value="<?php echo $row['special_day_ID']; ?>" type="checkbox"></td>
                                            <td><?php echo $count_no; ?></td>
                                            <td><?php  foreach($special_day_category_list as $key=> $value){ if($row['category']==$key){ echo $value; } } ?></td>
                                             <td><?php echo date('d-M-Y',$row['date']); ?></td>
											<td><a data-placement="top" data-toggle="tooltip" data-original-title="Edit" class="label label-primary" href="special_days.php?edit=1&select_id=<?php echo $row['special_day_ID'];?>"><i class="fa fa-pencil"></i></a>
                                            <a data-placement="top" data-toggle="tooltip" data-original-title="Delete" class="label label-danger" href="special_days.php?doaction=delete&select_id=<?php echo $row['special_day_ID'];?>"><i class="fa fa-times"></i></a><a  href="special_days_mail.php?select_id=<?php echo $row['special_day_ID'];?>"><span class="badge">Send Mail</span></a></td>
	...
	for(i=0;i<a.length;i++){
		...
		else
		{
			if(vl == 3)
			{
				...
				{
				form_name.action = "parish.php?doaction=publish";
				form_name.submit();
				}
				else
				return false;
			...
			else if(vl == 4)
			{
				...
				{
				form_name.action = "parish.php?doaction=unpublish";
				form_name.submit();
				}
				else
				return false;
