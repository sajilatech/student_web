...
<?php	$i++;	 }
 ...
 //else{?>
  <tr id="divSiblings"><td colspan="2"><table>
 fgdgfd
   </table></td></tr> 
   <tr>
   ...
   <!-- <td>Question Type</td>-->
    ...
    <?php 
	 if(!empty($question_answer_arr)){
      ...
      <div id="show_part_<?php echo $row['question_type_ID']; ?>" style="display:none;">
      <table>
      <?php for($c=1;$c<=10;$c++){?>
      <tr>
    <td>Ques.<?php echo $c;?></td>
    <td><input type="text" name="question_<?php echo $row['question_type_ID'];?>_<?php echo $c;?>"  class="form-control parsley-validated" id="question_<?php echo $row['question_type_ID'];?>_<?php echo $c;?>"  /></td>
  </tr>
    <tr>
    <td>Ans.<?php  echo $c;?></td>
    <td><input type="text" name="answer_<?php echo $row['question_type_ID'];?>_<?php echo $c;?>"  class="form-control parsley-validated" id="answer_<?php echo $row['question_type_ID'];?>_<?php echo $c;?>" ></td>
  </tr>
  <input type="hidden" name="question_type" id="question_type" value="<?php echo $row['question_type_ID']; ?>" />
  <?php
	  }
	  ?>
...
<input type='button' value='Delete' id='removeButton' class="btn btn-danger btn-xs">-->
 ...
 <?php /*?><?php if(!empty($question_answer_arr)){
	  $c=1;
	  foreach($question_answer_arr as $ro){?>
  	 <tr>
    <td>Ques.<?php echo $c;?></td>
